...
//     <div
//       ref={ref}
//       className="min-h-[200vh]  flex flex-col items-center py-20 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
//     >
//       <motion.h2
//         style={{
...
//         {title || (
//           <span>
//            Welcome to Nivarix Innovative Technologies <br /> Empowering Dreams, Transforming Realities.
//           </span>
//         )}
//       </motion.h2>
//       {/* Lid */}
...
//       {/* Lid */}
//       <Lid
//         videoSrc="https://nivarix.com/assets/184489-1080p-0_r-WEbT.mp4"
//         scaleX={scaleX}
//         scaleY={scaleY}
//         rotate={rotate}
//         translate={translate}
...
//   rotate: MotionValue<number>;
//   translate: MotionValue<number>;
//   videoSrc?: string; // Accepts video source
// }) => {
//   return (
//     <div className="relative [perspective:800px]">
//       <div
...
//         <video autoPlay loop className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full">
...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-10 md:py-10 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
          translateY: textTransform,
...
//         <div className="absolute inset-0 bg-[#272729] rounded-lg" />
//         {/* Replace Image with Video */}
//         <video  className="object-cover object-left-top absolute rounded-lg inset-0 h-full w-full">
//           <source src={videoSrc} type="video/mp4" />
//           {/* Add additional source elements for different video formats if needed */}
//           Your browser does not support the video tag.
//         </video>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        <div
          ...
          className="absolute inset-0 bg-[#010101] rounded-lg flex items-center justify-center"
        >
          <span className="text-white">Nivarix Innovative Technologies&reg;</span>
        </div>
      </div>
      <motion.div
        style={{
